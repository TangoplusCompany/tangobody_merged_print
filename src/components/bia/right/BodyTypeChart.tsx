  ...
  return (
    <div className="flex flex-col px-2 w-full h-full">
      ...
      <div className="relative ml-6 mb-2">
        ...
        {/* --- Y축 라벨 (BMI) --- */}
        <div className="absolute -left-6 top-0 h-full text-[8px] text-sub-400">
          <span className="absolute -top-2 left-0.5">BMI</span>
        ...
        <div className="grid grid-cols-3 grid-rows-4 w-full h-[150px] border border-sub-200 rounded-md text-[11px] text-sub-800 bg-white relative">
          ...
          {/* Row 1 */}
          <div className="border-b border-r border-sub-200 flex items-center justify-center">{t('bia_grid_burly')}</div>
          <div className="row-span-2 border-b border-r border-sub-200 flex items-center justify-center">{t('bia_grid_sturdy')}</div>
          <div className="border-b border-sub-200 flex items-center justify-center">{t('bia_grid_obese')}</div>

          {/* Row 2 */}
          <div className="border-b border-r border-sub-200 flex items-center justify-center">{t('bia_grid_solid')}</div>
          <div className="border-b border-sub-200 flex items-center justify-center">{t('bia_grid_plump')}</div>

          {/* Row 3 */}
          <div className="border-b border-r border-sub-200 flex items-center justify-center">{t('bia_grid_slender')}</div>
          <div className="border-b border-r border-sub-200 flex items-center justify-center">{t('bia_grid_average')}</div>
          <div className="row-span-2 border-sub-200 flex flex-col items-center justify-center leading-tight">
            {t('bia_grid_partially_fat')}
          </div>

          {/* Row 4 */}
          <div className="border-r border-sub-200 flex items-center justify-center">{t('bia_grid_skinny')}</div>
          <div className="border-r border-sub-200 flex items-center justify-center">{t('bia_grid_thin')}</div>
        ...
        {/* --- X축 라벨 (체지방률) --- */}
        <div className="absolute -bottom-0.5 left-0 w-full text-[8px] text-sub-400">
          <span className="absolute left-[33.33%] -translate-x-1/2">10.0</span>
          <span className="absolute left-[66.66%] -translate-x-1/2">20.0</span>
          <span className="absolute right-0">{t('bia_body_fat_pct')}</span>
        </div>
